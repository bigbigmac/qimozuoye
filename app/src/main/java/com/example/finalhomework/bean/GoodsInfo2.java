...
public class GoodsInfo2 {
    ...
    private static int[] mThumbArray = {
            R.drawable.oppo, R.drawable.meizu_s, R.drawable.iphone, R.drawable.huaweis, R.drawable.xiaomi,R.drawable.vivo, R.drawable.huaweimate40pro_s, R.drawable.huaweip40pro_s
    };
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {
            R.drawable.oppo, R.drawable.meizu_s, R.drawable.iphone, R.drawable.huaweis, R.drawable.xiaomi, R.drawable.vivo, R.drawable.huaweimate40pro, R.drawable.huaweip40pro
    };
